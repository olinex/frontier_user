...
pub fn main() -> i32 {
    // create semaphores
    assert_eq!(create_semaphore(true, 1) as usize, SEM_MUTEX);
    assert_eq!(create_semaphore(true, BUFFER_SIZE as isize) as usize, SEM_EMPTY);
    assert_eq!(create_semaphore(true, 0) as usize, SEM_AVAIL);
    // create threads
